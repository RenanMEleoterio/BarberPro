...
namespace BarbeariaSaaS.Migrations
{
    ...
    [Migration("20260121160614_AddAgendamentoServicos")]
    partial class AddAgendamentoServicos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BarbeariaSaaS.Models.AgendamentoServico", b =>
                {
            ...
            modelBuilder.Entity("BarbeariaSaaS.Models.Barbearia", b =>
                {
                    ...
                    b.Property<string>("CodigoBarbearia")
                        .IsRequired()
                        .HasMaxLength(8)
            ...
            modelBuilder.Entity("BarbeariaSaaS.Models.Servico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BarbeariaSaaS.Models.Agendamento", b =>
                {
                    ...
                    b.HasOne("BarbeariaSaaS.Models.HorarioDisponivel", "HorarioDisponivel")
                        .WithMany("Agendamentos")
            ...
            modelBuilder.Entity("BarbeariaSaaS.Models.AgendamentoServico", b =>
                {
                    b.HasOne("BarbeariaSaaS.Models.Agendamento", "Agendamento")
                        .WithMany("AgendamentoServicos")
                        .HasForeignKey("AgendamentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BarbeariaSaaS.Models.Servico", "Servico")
                        .WithMany("AgendamentoServicos")
